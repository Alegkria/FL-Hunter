...
from FL_Hunter.models.interface import FL_HunterModuleProtocol
from FL_Hunter.models.node_weight_predictor import NodeWeightPredictor



class MLP(FL_HunterModuleProtocol):
    @profile
    def __init__(
            self,
            node_types: List[str],
...
class MLPGraphClf(nn.Module):
    ...
    def __init__(
        ...
        )  # 将 attn_w 注册为模型的参数，使得 attn_w 可以被优化和更新
